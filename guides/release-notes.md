...
You can now use the [`onViewChange()`](https://www.wix.com/velo/reference/$w/datepicker/onviewchange) API to add an event handler that triggers when the date picker's view changes.
