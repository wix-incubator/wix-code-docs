...
With the Wix Extended Bookings API you can retrieve bookings for a site's services.  
The booking object holds information about the customer and the session or 
schedule they have booked. 
### Terminology
...
To use the Bookings V2 API, import `{ extendedBookings }` from the `wix-bookings.v2` module:
