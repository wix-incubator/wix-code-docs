...
| Inbox                                                   |
| ------------------------------------------------------- |
| ![Form message in Wix Inbox](../images/form__inbox.png) |
...
| Inbox                                                         |
| ------------------------------------------------------------- |
| ![Minimal message in Wix Inbox](../images/minimal__inbox.png) |
...
| Inbox                                                           | Chat Widget                                                                 |
| --------------------------------------------------------------- | --------------------------------------------------------------------------- |
| ![Template message in Wix Inbox](../images/template__inbox.png) | ![Template message in the chat widget](../images/template__chat-widget.png) |
...
| Inbox                                                       |
| ----------------------------------------------------------- |
| ![System message in Wix Inbox](../images/system__inbox.png) |