/* This code was used in the original Velo reference to
* generate a list of developer preview functions for the
* developer preview article. No longer relevant in the 
* new portal.
*/
